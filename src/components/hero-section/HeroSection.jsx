      ...
      <div className='w-full flex md:gap-9 gap-6 md:items-start items-center'>
        ...
        <div className='w-full'>
          <div className='w-full flex md:flex-row flex-col gap-3 justify-between'>
            <div>
              <p className='md:block hidden font-semibold text-[1.7rem]'>
                Ujjwal Kumar
              </p>
              <p className='md:hidden block font-semibold text-[1.3rem]'>
                Ujjwal Kumar
              </p>
              <p className='text-[#e76231]'>Aspiring ML Engineer</p>
            </div>
