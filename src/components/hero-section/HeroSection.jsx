...
const HeroSection = () => {
  ...
  return (
    <motion.section 
    className='bg-[#171717] md:w-[60%] w-[85%] md:p-9 p-5 mx-auto md:text-[1.25rem] text-[1rem] text-gray-300  rounded-lg border border-gray-800 shadow-lg md:mt-10 mt-8'
    ...
    >
      <div className='w-full flex gap-6'>
        <img src={pfp} alt="pfp" className='md:w-29 md:h-29 w-23 h-23 rounded-lg' />

        <div className='w-full'>
          <div className='w-full flex md:flex-row flex-col gap-3 justify-between'>
            <div>
              <p className='md:block hidden font-semibold md:text-[1.5rem] text-[1.25rem] text-[#e5e5e5]'>
                Ujjwal Kumar
              </p>
              <p className='md:hidden block font-semibold text-[1.25rem] text-[#e5e5e5]'>
                Ujjwal
              </p>
              <p className='md:hidden block font-semibold text-[1.25rem] text-[#e5e5e5]'>
                Kumar
