...
const HeroSection = () => {
  ...
  return (
    <motion.section 
    className='bg-[#171717] sm:w-[60%] w-[85%] sm:p-9 p-5 mx-auto  sm:text-[1.25rem] text-[1rem] text-gray-300  rounded-lg border border-gray-800 shadow-lg'
      ...
      <div className='w-full flex gap-6'>
        ...
        <div className='w-full'>
          ...
          <div className='mt-4 sm:block hidden'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" height="21" viewBox="0 0 24 24" width="21" fill="oklch(0.872 0.01 258.338)">
