...
const ProjectCard = ({ projectName, desc }) => {
  return (
    <motion.div 
    className='bg-[#171717] text-gray-300 md:w-[48%] w-[97%] h-fit border border-gray-800 rounded-lg p-6 shadow-lg'
    whileHover={{
      scale:1.03,
    ...
    >
      <div className='w-full flex justify-between'>
        <p className='font-semibold text-[#e5e5e5]'>{projectName}</p>
        ...
        <div className='flex gap-1 items-center'>
          ...
          <svg
            ...
            >
              <path d="m17.086 11.5-5.043-5.04 1.414-1.42 7.457 7.46-7.457 7.46-1.414-1.42 5.043-5.04H3.5v-2z" fill='#e5e5e5'></path>
            </svg>
