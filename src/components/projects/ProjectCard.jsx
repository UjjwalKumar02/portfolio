...
const ProjectCard = ({ projectName, desc, pfp, github, live }) => {
  return (
    <div 
    className='bg-[#f5f5f5] dark:bg-[#171717] dark:border-gray-700 dark:text-[#a3a3a3] w-[97%] text-gray-800 h-fit border border-gray-300 p-8 md:py-11 md:px-10 shadow-sm text-[0.95rem] md:text-[1.1rem] rounded-md'
    >
      <div className='flex md:flex-row flex-col items-center md:gap-16 gap-5'>
        ...
        <div className=''>
          <p className='font-semibold md:text-[1.35rem] text-[1.2rem] dark:text-[#f5f5f5]'>{projectName}</p>
          ...
          <div className='flex flex-wrap gap-2 mt-6'>
            <span>
              <a 
              href={github} 
              className='flex gap-2 items-center justify-center md:px-6 px-5 py-1.5 bg-black  rounded-md cursor-pointer text-[1rem] dark:border dark:border-gray-700 dark:bg-[#171717] text-[#f5f5f5]'
              >
