...
const ProjectCard = ({ projectName, desc, pfp, github, live }) => {
  return (
    <div 
    className='md:w-[48%] bg-white dark:bg-[#171717] dark:border-gray-600 dark:text-gray-300 text-gray-800 h-fit border border-gray-300 p-8 md:py-11 md:px-10 shadow-sm text-[0.95rem] md:text-[1rem] rounded-lg'
    >
      <div className='flex md:flex-row flex-col items-center md:gap-16 gap-5'>
        ...
        <div className=''>
          <p className=' md:text-[1.35rem] text-[1.2rem] dark:text-[#f5f5f5] text-center'>{projectName}</p>
          ...
          <div className='flex flex-wrap gap-2 mt-7 justify-center'>
            <span>
              <a 
              href={github} 
              className='flex gap-2 items-center justify-center md:px-6 px-5 py-1.5 bg-[#1d293f]  rounded-md cursor-pointer text-[1rem] dark:border dark:border-gray-700 dark:bg-[#f5f5f5] dark:text-black text-[#f5f5f5]'
              >
