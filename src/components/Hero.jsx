...
const Hero = () => {
  return (
    <div
      id="about"
      className="lg:max-w-4xl max-w-[91%] mx-auto bg-white lg:p-10 p-8 flex flex-col-reverse gap-10 sm:flex-row justify-between items-center rounded-2xl shadow-sm border-[1.5px] border-gray-300 mt-10"
    >
      <div className="md:max-w-[60%] md:space-y-4 space-y-2">
        ...
        <p className="md:text-left text-center lg:text-base text-sm">
          B.Tech student at MAIT, and Web
          developer.
        </p>
