...
const Contact = () => {
  return (
    <div className='w-fit bg-white flex items-center gap-6 px-3 py-2 rounded-lg shadow-lg border border-gray-400 fixed bottom-0 left-1/2 transform -translate-x-1/2'>
      <a href="">
      ...
      <a href="">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 21" id="linkedin-bug-blue-xsmall" aria-hidden="true" role="none" data-supported-dps="21x21" width="20" height="20" focusable="false" className="windows-app-upsell__linkedin-bug-icon-svg lazy-loaded" aria-busy="false">
                  <g>
