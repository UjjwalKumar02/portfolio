...
const Contact = () => {
  return (
    <div className='w-fit bg-[#171717] flex justify-center items-center gap-6 px-5 py-2 rounded-lg shadow-lg border border-gray-800 sticky bottom-0 left-1/2 transform -translate-x-1/2'>
      ...
      {/* <a href="">
      <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="25" fill="#e5e5e5">
  <path d="M6 2C5.45 2 5 2.45 5 3V21C5 21.55 5.45 22 6 22H18C18.55 22 19 21.55 19 21V3C19 2.45 18.55 2 18 2H6ZM17 20H7V4H17V20ZM9 6H15V7H9V6ZM9 8H15V9H9V8ZM9 10H15V11H9V10ZM9 12H15V13H9V12ZM9 14H15V15H9V14ZM9 16H15V17H9V16Z"/>
</svg>
