...
const Contact = () => {
  return (
    <div className='w-fit bg-white flex items-center gap-6 px-5 py-3 rounded-lg shadow-lg border border-gray-400 sticky bottom-0 left-1/2 transform -translate-x-1/2'>
      <a href="">
