...
const Contact = () => {
  return (
    <div className='w-fit bg-[#050505] flex justify-center items-center gap-6 px-5 py-3 rounded-lg shadow-lg border border-gray-400 sticky bottom-0 left-1/2 transform -translate-x-1/2'>
      <a href="">
      ...
      <a href="">
        <img src={resume} alt="" className='w-6'/>
      </a>
    </div>
  )
}
