...
const About = () => {
  ...
  return (
    <motion.section 
    className='sm:w-[60%] w-[90%] sm:p-7 px-4 py-6 sm:text-[1.25rem] text-[1rem] text-gray-600 mx-auto'
    ...
    >
      <div>
        <p className='sm:text-[1.5rem] text-[1.25rem] font-semibold text-black'>
          About
        </p>
        <p className='mt-4'>
        ...
        <p className='mt-4'>
        I find it exciting to work on projects that involve predictive modeling and natural language processing.
        </p>
      </div>
    </motion.section>
  )
